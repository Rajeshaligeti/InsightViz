...
import pandas as pd
import matplotlib
matplotlib.use('Agg')  # Required for headless/serverless (e.g. Vercel)
        ...
        if form.is_valid():
            ...
            if x_axis and y_axis and plot_type:
                try:
                    ...
                    # Add detailed data summary (describe can fail on non-numeric; use try)
                    try:
                        summary = {
                    ...
                    context['plot_error'] = f'Could not generate plot: {str(e)}'
